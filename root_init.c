...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/06 12:06:36 by akapusti          #+#    #+#             */
/*   Updated: 2023/09/06 16:37:08 by akapusti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	texture_load(root, &root->player, "./img/player1.xpm");
	texture_load(root, &root->exit, "./img/player2.xpm");
	texture_load(root, &root->coll, "./img/beer.xpm");
	texture_load(root, &root->wall, "./img/wall.xpm");
	texture_load(root, &root->ground, "./img/floar.xpm");
}
